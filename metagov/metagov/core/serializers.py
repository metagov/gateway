...
def create_or_update_plugin(plugin_name, plugin_config, community):
    ...
    try:
        ...
        if plugin.config != plugin_config:
            ...
            plugin.delete()
            cls.objects.create(name=plugin_name, community=community, config=plugin_config)
        else:
...
class CommunitySerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        for data in plugins:
            create_or_update_plugin(plugin_name=data.get("name"), plugin_config=data.get("config"), community=instance)
